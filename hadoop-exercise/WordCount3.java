...
public class WordCount3 {
    ...
    public static class KeySort extends Comparator {
    ...
    public static class limitReduce extends Reducer<IntWritable, Text, IntWritable, Text> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        jobsort.setReducerClass(limitReduce.class);
        ...
        jobsort.setSortComparatorClass(KeySort.class);
